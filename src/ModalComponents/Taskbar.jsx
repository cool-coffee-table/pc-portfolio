...
export default function Taskbar({ id, toggleMaximized, close, toggleMinimized}) {
  return (
    <div className="pl-2 flex items-center select-none border-b  border-lightBlack">
      ...
      <div className="flex h-8 items-center justify-center">
        <span className="hover:bg-lightBlack flex items-center h-full px-2 cursor-pointer" onClick={toggleMinimized}>
          <VscChromeMinimize />
        </span>
        <span className="hover:bg-lightBlack flex items-center h-full px-2 cursor-pointer" onClick={toggleMaximized}>
          <VscChromeMaximize />
        </span>
